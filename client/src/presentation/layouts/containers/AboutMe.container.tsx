...
export const AboutMeContainer = () => {
    return (
        <div className='relative container mx-auto md:p-4'>
            <div className="text-gray-900 bg-slate-200 p-2 md:p-8 rounded-md shadow-lg space-y-4 md:space-y-6">
                <h1 className="text-4xl font-extrabold text-center mb-4 text-blue-600">
                    Sobre mí
                </h1>
                <section className="space-y-4">
                    <h2 className="text-xl md:text-2xl font-bold">👋 ¡Hola! Soy Juan Valero</h2>
                ...
                <section className="space-y-4">
                    <h2 className="text-xl md:text-2xl font-bold">🎯 ¿Qué me distingue?</h2>
                ...
                <section className="space-y-4">
                    <h2 className="text-xl md:text-2xl font-bold">🚀 Lo que me motiva</h2>
                    <p className="text-base md:text-lg">
