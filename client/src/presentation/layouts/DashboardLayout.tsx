                ...
                <div className="fixed bottom-8 mx-auto flex flex-col justify-center items-center px-6">
                    <div className="text-sm space-y-2">
                        <div className="flex flex-row items-center space-x-2">
                            <FaEnvelope className="text-indigo-500 text-lg transform -translate-y-2" />
                            <p className='leading-none'>juankvalerov@gmail.com</p>
                        </div>
                        <div className="flex flex-row items-center space-x-2">
                            <FaPhoneAlt className="text-indigo-500 text-lg transform -translate-y-2" />
                            <p className='leading-none'>(57) 313-712-7520</p>
                        </div>
                        <div className="flex flex-row items-center space-x-2">
                            <FaMapMarkerAlt className="text-indigo-500 text-lg transform -translate-y-2" />
